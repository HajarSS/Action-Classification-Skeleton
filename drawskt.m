% USAGE: drawskt(1,3,1,4,1,2) --- show actions 1,2,3 performed by subjects
% 1,2,3,4 with instances 1 and 2.
...
%aviobj = VideoWriter('skeleton.avi'); %Create new Audio
%open(aviobj);
...
for s=1:size(X,2)
    ...
    pause(1/20)
    print(fig,'-djpeg',['act_',num2str(s),'.jpg']);
   % writeVideo(aviobj,getframe(gcf));
end

%close(aviobj);  % Close the file
